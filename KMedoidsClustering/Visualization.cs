...
namespace KMedoidsClustering
{
    class Visualization
    {
        ...
        public static bool DrawX(PictureBox pan, Point pt1)
        {
            Graphics dc = pan.CreateGraphics();
            Brush br = new SolidBrush(Color.Red);
            Point p1a = new Point(pt1.X - 2, pt1.Y - 2);
            Point p2a = new Point(pt1.X + 2, pt1.Y + 2);
            dc.DrawLine(new Pen(Color.Red, 3), p1a, p2a);
            Point p3a = new Point(pt1.X + 2, pt1.Y - 2);
            Point p4a = new Point(pt1.X - 2, pt1.Y + 2);
            dc.DrawLine(new Pen(Color.Red, 3), p3a, p4a);
