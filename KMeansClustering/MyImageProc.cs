...
namespace KMeansClustering
{
    class MyImageProc
    {
        public static bool DrawX(Graphics g, Point pt1)
        {
            ...
            g.DrawLine(new Pen(color: Color.Red, width: 2), p1a, p2a);
            Point p3a = new Point(pt1.X + 4, pt1.Y - 4);
            Point p4a = new Point(pt1.X - 4, pt1.Y + 4);
            g.DrawLine(new Pen(color: Color.Red, width: 2), p3a, p4a);
            return true;
        }
        ...
        public static bool DrawClusters(PictureBox pan, List<MyPoint> PList, double scale, int clusterCount)
        {
            ...
            GetClusterColors(clusterCount, ref CColors);
            ...
            dc.DrawLine(new Pen(CColors[PList[0].ClusterId], width: 1), p1a, p2a);
            Point p3a = new Point((int)(p1.X * scale) + 2, (int)(p1.Y * scale) - 2);
            Point p4a = new Point((int)(p1.X * scale) - 2, (int)(p1.Y * scale) + 2);
            dc.DrawLine(new Pen(CColors[PList[0].ClusterId], width: 1), p3a, p4a);
            ...
            for (int i = 1; i < PList.Count; i++)
            {
                ...
                dc.DrawLine(new Pen(CColors[PList[i].ClusterId], width: 1), p1a, p2a);
        ...
        private static void GetClusterColors(int clusterCount, ref Color[] CColors)
        {
